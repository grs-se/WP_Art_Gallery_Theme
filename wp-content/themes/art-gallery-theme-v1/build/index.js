...
/* harmony import */ var _modules_GalleryFiltersMenu__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/GalleryFiltersMenu */ "./src/modules/GalleryFiltersMenu.ts");
...
/* harmony import */ var _modules_Slider1__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/Slider1 */ "./src/modules/Slider1.ts");
...
// import Slider from './modules/SpotlightSlider'
...
const spotlightSlider = new _modules_Slider1__WEBPACK_IMPORTED_MODULE_6__["default"]();
// const subMenu = new SubMenu()
const galleryFiltersMenu = new _modules_GalleryFiltersMenu__WEBPACK_IMPORTED_MODULE_1__["default"]();
// const slider = new Slider()

/***/ }),

/***/ "./src/modules/GalleryFiltersMenu.ts":
/*!*******************************************!*\
  !*** ./src/modules/GalleryFiltersMenu.ts ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
class GalleryFiltersMenu {
  ...
  events() {
    if (this.filtersMenuToggle) {
      this.filtersMenuToggle.forEach(el => el.addEventListener('click', e => {
        e.preventDefault();
        this.toggleOverlay();
      }));
    }
    if (this.closeButton) this.closeButton.addEventListener('click', () => this.closeOverlay());
    this.filtersTrigger.forEach(el => el.addEventListener('click', e => {
      // e.preventDefault()
      this.filterLogic();
    }));
  ...
  openOverlay() {
    if (this.filtersMenuOverlay) this.filtersMenuOverlay.classList.add('gallery-filters-menu-overlay--active');
  ...
  closeOverlay() {
    if (this.filtersMenuOverlay) this.filtersMenuOverlay.classList.remove('gallery-filters-menu-overlay--active');
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (GalleryFiltersMenu);
...
class Search {
  ...
  async getResults() {
    try {
      const response = await axios__WEBPACK_IMPORTED_MODULE_0__["default"].get(galleryData.root_url + '/wp-json/gallery/v1/search?term=' + this.searchField.value);
      ...
      this.resultsDiv.innerHTML = `
        <div class="row">
          ...
          <div class="one-third">
            ...
            ${results.programs.length ? '<ul class="link-list min-list">' : `<p>No artworks match that search. <a href="${galleryData.root_url}/programs">View all artworks</a></p>`}
              ${results.programs.map(item => `<li><a href="${item.permalink}">${item.title}</a></li>`).join('')}
            ${results.programs.length ? '</ul>' : ''}

            <h2 class="search-overlay__section-title">Categories</h2>
            ${results.professors.length ? '<ul class="professor-cards">' : `<p>No categories match that search.</p>`}
          ...
          <div class="one-third">
            ...
            ${results.campuses.length ? '<ul class="link-list min-list">' : `<p>No locations match that search. <a href="${galleryData.root_url}/campuses">View all locations</a></p>`}
              ${results.campuses.map(item => `<li><a href="${item.permalink}">${item.title}</a></li>`).join('')}
            ${results.campuses.length ? '</ul>' : ''}

            <h2 class="search-overlay__section-title">Events</h2>
            ${results.events.length ? '' : `<p>No events match that search. <a href="${galleryData.root_url}/events">View all events</a></p>`}
      ...
      <div class="search-overlay">
        <div class="search-overlay__top">
          <div class="container">
            ...
            <input type="text" class="search-term" placeholder="Search Collection" id="search-term">
...
class SpotlightSlider {
  slider = document.querySelector('.spotlight-slider');
  slides = document.querySelectorAll('.spotlight-slider__slide');
  dots = document.querySelector('.glide__bullets');
  // glide: Glide;
  ...
  constructor() {
    if (this.slider) {
      ...
      // Actually initialize the glide / slider script
      const glide = new _glidejs_glide__WEBPACK_IMPORTED_MODULE_0__["default"](this.slider, {
        type: 'carousel',
        startAt: 0,
        perView: 3,
        autoplay: 3000,
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (SpotlightSlider);
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = globalThis["webpackChunkgallery_theme"] = globalThis["webpackChunkgallery_theme"] || [];
